...
**`v4.1.0+`版本之后默认 master 分支将不支持国际化，有需要的请使用[i18n](https://github.com/Oct072021/warehouse-management-system/tree/i18n)分支，它会和 master 保持同步更新**

**该项目不支持低版本浏览器(如 ie)，有需求请自行添加 polyfill [详情](https://github.com/Oct072021/warehouse-management-system/wiki#babel-polyfill)**
...
群主 **[圈子](https://jianshiapp.com/circles/1209)** 群主会经常分享一些技术相关的东西，或者加入 [qq 群](https://github.com/Oct072021/warehouse-management-system/issues/602) 或者关注 [微博](https://weibo.com/u/3423485724?is_all=1)
